...
class RestoreBackupHelper {
     ...
     * @throws \Exception
     */
    protected function restoreKeys(array $keys, $user) {
     ...
     * @param null|string $user
     */
    protected function restoreData(array $data, $user) {
     ...
     * @param null|string            $user
     */
    protected function restoreModels(array $models, AbstractMapper $modelMapper, AbstractRevisionMapper $revisionMapper, string $modelClass, string $revisionClass, $user) {
     ...
     * @param null|string    $user
     */
    protected function restoreEntities(array $entities, AbstractMapper $entityMapper, string $class, $user) {
     ...
     * @param null|string    $user
     */
    protected function deleteEntities(AbstractMapper $entityMapper, $user) {
     ...
     * @throws \Exception
     */
    protected function restoreUserSettings($userSettings, $user) {
     ...
     * @throws \Exception
     */
    protected function restoreClientSettings($clientSettings, $user) {
